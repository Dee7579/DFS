...
build-tools 35.0.0, and NDK 26.1.10909125. The workflow:
...
5. Verifies the APK structure and uploads the APK plus SHA-256 checksum.
...
python android/build_android.py \
  ...
  --ndk-path "$ANDROID_SDK_ROOT/ndk/26.1.10909125"
```
