...
set "REPORT=%~dp0logs\tactical_sprint_005_report.txt"
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 005 VERIFIED
echo ============================================================
echo.
...
:run_checks
echo Verifying certified sources before Tactical Assistant scenario tests...
python verify_certified_sources.py
if errorlevel 1 exit /b 1

echo.
echo Compiling Tactical Assistant Sprint 005 modules...
python -m compileall -q dfs\domain\tactical dfs\services\tactical dfs\infrastructure\tactical dfs\ui\tactical_assistant
if errorlevel 1 exit /b 1

echo.
echo Running Tactical Assistant regression and Sprint 005 tests...
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 005 FAILED
echo ============================================================
echo.
