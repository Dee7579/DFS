...
set "REPORT=%~dp0logs\tactical_sprint_004_report.txt"
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 004 VERIFIED
echo ============================================================
echo.
...
echo.
echo Compiling Tactical Assistant Sprint 004 modules...
python -m compileall -q dfs\domain\tactical dfs\services\tactical dfs\infrastructure\tactical dfs\ui\tactical_assistant
if errorlevel 1 exit /b 1

echo.
echo Running Tactical Assistant regression and Sprint 004 tests...
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 004 FAILED
echo ============================================================
echo.
