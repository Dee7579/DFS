...
set "REPORT=%~dp0logs\tactical_sprint_003_report.txt"
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 003 VERIFIED
echo ============================================================
echo.
...
:run_checks
echo Verifying certified sources before Tactical Assistant combat tests...
python verify_certified_sources.py
if errorlevel 1 exit /b 1

echo.
echo Compiling Tactical Assistant combat modules...
python -m compileall -q dfs\domain\tactical dfs\infrastructure\tactical dfs\ui\tactical_assistant
if errorlevel 1 exit /b 1

echo.
echo Running Tactical Assistant regression and Sprint 003 tests...
...
echo.
echo ============================================================
echo TACTICAL ASSISTANT SPRINT 003 FAILED
echo ============================================================
echo.
